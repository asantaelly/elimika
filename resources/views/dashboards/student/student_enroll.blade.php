...
<html lang="en">
    ...
    <head>
        ...
        <title>DIT-Online | Welcome</title>
        <!-- Styles -->
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="/home/course/{{ $course->id}}">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        ...
                        <h4 class="mt-4">Course Enrollment</h4>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active text-center">Elimika-Online</li>
                        </ol>
